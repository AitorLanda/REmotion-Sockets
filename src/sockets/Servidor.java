...
public class Servidor {
	...
	public static class MyThreadServicioASocket extends Thread {
		...
		public void run(){
			...
			try {
				...
				case "Verificar Username Fisio":
					...
					break;
				case "Cargar Ejercicios":
					cargarEjercicios();
					break;
					
				case "Buscar ID Ejercicio":
					buscarIdEjercicio();
					break;
				default:
		...
		private void buscarIdEjercicio() {
			System.out.println("he entrado a buscar ID ejercicio");
			GestorFicheros.buscarIdEjercicio(datosRecibidos[0], out);
		}
		...
		private void cargarDatosEjercicio() {
			System.out.println("he entrado en Cargar Datos Ejercicio");
			
			GestorFicheros.cargarDatosEjercicio(datosRecibidos[ID], out);
			
		}
		
		private void cargarEjercicios() throws IOException {
			System.out.println("he entrado en Cargar Ejercicios");
			String[]ejercicios=GestorFicheros.cargarEjercicios();
			out.writeUTF(String.valueOf(ejercicios.length));
			for(int i = 0; i < ejercicios.length; i++) {
				out.writeUTF(ejercicios[i]);
			}
		}
		...
		private void buscarSesion() {
			System.out.println("he entrado en buscar sesion");
			GestorFicheros.buscarSesion(datosRecibidos[USERNAME]);
		}
